...
const sendWelcomeEmail = (email, name) => {
  sgMail.send({
    ...
    html: `<div>
             ...
             <div style="font-family: inherit; text-align: justify inherit">Welcome ${name}. Thanks for joining to our community. Please click the <strong>DanceWithMe</strong> button to explore the latest dance events and find your best partner!&nbsp;</div>
