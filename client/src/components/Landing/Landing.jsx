      ...
      <Carousel>
        <Carousel.Item>
          ...
          <Carousel.Caption>
            ...
            <p className="text-danger font-weight-bold">
              In Belgium there are many people looking for a dance partner
            </p>
          </Carousel.Caption>
        </Carousel.Item>
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption>
            ...
            <p class="pl-5 text-uppercase font-weight-bold">
              <span class="text-light">Be- </span>
              <span class="text-dark">active together with DanceWithMe</span>
            </p>
