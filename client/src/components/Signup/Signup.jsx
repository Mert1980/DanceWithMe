...
function SignUp() {
  ...
  console.log(more_about_you)
  console.log(gender)
  console.log(age)
  console.log(weight)
  console.log(height)
  console.log(partner_gender)
  console.log(partner_age)
  console.log(partner_weight)
  console.log(partner_height)
  console.log(dance_preference)
            ...
            <div className="progress">
                ...
                <div className="container">
                  ...
                  <div className="container border border-top-0 border-info px-5 py-2">
                    ...
                    <div w-100>
                      <h6 className="mt-5">
                        Which type of dance you want to do together?
                      </h6>
